...
jfk_to_sea <- flights %>% filter(origin == "JFK" & dest == "SEA") %>% select(air_time)
print(mean(jfk_to_sea$air_time, na.rm = TRUE))
print(min(jfk_to_sea$air_time, na.rm = TRUE))
print(max(jfk_to_sea$air_time, na.rm = TRUE))
