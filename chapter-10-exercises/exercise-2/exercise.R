...
salaries_for_2017 <- runif(100, 4000, 5000)
...
salaries <- data.frame(employees, salaries_for_2017, adjustments, stringsAsFactors = FALSE)
...
salary_change <- salaries[salaries$adjustments == salaries$adjustments, "adjustments"]
mean(salary_change)
# For people who did not get a raise, how much money did they lose on average?
loss_on_avg <- salaries[ salaries$adjustments < 0, "adjustments"]
mean(loss_on_avg)
